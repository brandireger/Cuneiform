...
def main():
    ...
    v2 = "--v2" in sys.argv
    if v2 and not patched:
        sys.exit("--v2 requires --patched (v2 is the corrected-H1 patched run)")
    results_root = Path("results_p3_patched_v2") if v2 else (Path("results_p3_patched") if patched else RESULTS)
