...
./inventory_out/. Designed to DISCOVER the schema, not assume it.
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("Usage: python 01_inventory.py /path/to/TLHdig_0.2.0-beta.zip")
    main(sys.argv[1])
